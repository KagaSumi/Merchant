...
namespace {
    ...
    Entity &createPriceSelection(Scene &scene, Entity &overlay) {
        ...
        titleLabelEntity.addComponent<Transform>(Vector2D(centerLineX - (tLabelComp.dst.w / 2.0f), startY - 40.0f),
                                                 0.0f,
                                                 1.0f);
